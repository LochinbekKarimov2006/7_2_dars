...
function Navbar() {
  ...
  return (
    ...
    <div className="navbar max-w-[1232px] mx-auto ">
    <div className="navbar-start">
      <div className="dropdown">
        ...
        <ul
          ...
          <li><NavLink to="/goloreya">Goloreya</NavLink></li>
        </ul>
      </div>
      <a className="btn bg-[#2600fa] text-blue-gray-50 text-3xl">L</a>
    </div>
    ...
    <div className="navbar-end pr-[16px]">
